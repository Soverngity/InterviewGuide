...
https://www.cnblogs.com/Neroi/p/13902913.html
...
- **FULLTEXT** ：即为全文索引，MyISAM、MySQL5.6.24以后的InnoDB引擎支持。其可以在CREATE TABLE ，ALTER TABLE ，CREATE INDEX 使用，不过目前只有 CHAR、VARCHAR ，TEXT 列上可以创建全文索引。
